...
/*   Updated: 2023/06/15 19:06:48 by thibnguy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	mat = (t_matrix *)param;
// 	if (key == 4)
// 		wheel_event(key, x, y, mat);
// 	else if (key == 5)
// 		mouse_press_hook(key, x, y, mat);
// 	else if (key == 7)
// 		mouse_release_hook(key, x, y, mat);
// 	else if (key == 6)
// 		mouse_movement_hook(x, y, mat);
// 	return (0);
// }
